...
strings.signIn = {
  ...
  privacy_policy_links:
    "By clicking Sign Up, you agree to our <a href='{{$1}}'>Privacy Policy</a> and <a href='{{$2}}'>Terms of Use</a>",
...
strings.share = {
  ...
  reached_collaborators_limit:
    'You have reached maximum number of collaborators limit. Please upgrade.',
  ...
  collaborator_invite_email_tmpl:
    "Hello, <br/><br> Congratulations! You now have access to <b><%= appName %></b> on Kadira. <br> Please <a href='<%= inviteUrl %>'>Visit Kadira</a> to begin.<br>If you are new to Kadira, you can log in using your email and 'knotel2018' as a password. Please, change your password after the first logon!<br><br>Thank You!",
  ...
  notify_new_owner_email_templ:
    "Hello, <br/><br> Congratulations! You are invited to become the owner of application <a href='<%= appLink %>'><%= appName %></a> on Kadira. Click <a href='<%= inviteUrl %>'> here </a> to accept invitation.<br>If you are new to Kadira, you can log in using your email and 'knotel2018' as a password. Please, change your password after the first logon!<br><br>Thank You!",
...
strings.tools = {
  ...
  install_kadira_profiler_msg:
    'Make sure you\'ve installed <a href="https://github.com/meteorhacks/kadira-profiler" target="_blank"><b>Kadira Profiler package</b></a> into your app:<code>meteor add meteorhacks:kadira-profiler</code>',
  duration: 'Duration',
  name: 'Name',
